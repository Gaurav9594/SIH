...
import PasswordStrengthMeter from "../components/PaawordStrengthMeter";
		...
		>
			<div className='p-8'>
				...
				<form onSubmit={handleSignUp}>
					...
					<motion.button
						className='mt-5 w-full py-3 px-4 bg-gradient-to-r from-orange-500 to-orange-900 text-white 
						font-bold rounded-lg shadow-lg hover:from-orange-500
